...
headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36'} # global headers to be used for requests
...
def extract_movie_details(movie_link):
    ...
    if movie_soup is not None:
        ...
        with open('/Users/rvf_alves/Documents/Comp/CursoPython/Python_avancado/EBAC-python-concurrency/movies_single.csv', mode='a') as file:
